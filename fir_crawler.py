...
class TsCrawler(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Firefox(executable_path=r'C:\Selenium\geckodriver.exe')
    ...
    def test_ts_crawler(self):
        ...
        for date_value in dates:
            ...
            ofile = codecs.open("C:/Users/Acer/Desktop/Arrest/" + name + ".html", "w", "utf-8")
            ofile.write(html)
            ofile.close()
